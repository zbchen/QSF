...
OTHER_SOLVERS=(z3 cvc5 mathsat5 bitwuzla colibri jfs_lf_fail_fast_smart_seeds gosat)
#OTHER_SOLVERS=(colibri jfs_lf_fail_fast_smart_seeds coral_pso xsat gosat optsat)
JFS_SOLVER="optsat"
#bset="smtlib_qf_fp"
